...
class MainFrame ( wx.Frame ):
	...
	def __init__( self, parent ):
		...
		self.m_spinCtrlLen = wx.SpinCtrl( self, wx.ID_ANY, wx.EmptyString, wx.DefaultPosition, wx.DefaultSize, wx.SP_ARROW_KEYS, 1, 256, 254 )
		...
		self.m_spinCtrlTime = wx.SpinCtrl( self, wx.ID_ANY, wx.EmptyString, wx.DefaultPosition, wx.DefaultSize, wx.SP_ARROW_KEYS, 0, 5000, 0 )
